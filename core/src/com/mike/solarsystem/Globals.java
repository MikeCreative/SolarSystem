...
public class Globals {
    ...
    public static String[] planetTitles = {"Sun", "Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune", "Earth's Moon"};
    public static float[] planetDensitiesSimulation = {1.408f, 5.427f, 5.243f, 5.514f, 3.93f, 1.326f, 0.687f, 1.27f, 1.638f, 0.00371f};  // Moon divided by 30 * 30
    public static float[] planetRadiusSimulation = {69.634f, .25f, .605f, .637f, .34f, 6.91f, 5.82f, 2.536f, 2.4622f, 0.174f};
    public static float[] planetRadiusArcade = {69.634f, 25f, 60.5f, 20, 34f, 69.11f*2, 58.2f*2, 253.6f, 246.22f, 4f};
    public static float[] planetMaxXDistance = {0f, 700, 1090, 1520, 2490, 8170, 15100, 30000, 45500, 30f}; // Changed Moon * 30
    ...
    public static int NUMBER_OF_MOONS = 0;
