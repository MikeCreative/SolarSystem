...
public class Globals {
    ...
    public static float[] PLANETZOOMLEVELSIMULATION = {0.03f, 0.0002f, 0.001f, 0.001f, 0.001f, 0f};
    public static float[] PLANETZOOMLEVELARVADE = {0.07f, 0.005f, 0.01f, 0.01f, 0.1f, 0f};
